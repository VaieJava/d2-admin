  ...
  <div>
    <el-table
      ...
      <el-table-column label="角色" align="center" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          <template v-for="r in scope.row.roles">
            <el-button type="text">{{r.roleName}}</el-button>
          </template>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-row>
              <el-button @click="handleDialogOpen" type="primary"  size="small" icon="el-icon-edit" circle></el-button>
